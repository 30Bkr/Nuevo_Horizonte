...
<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <div class="container">
      ...
      <br>
      <form action="http://localhost/project/global/controllers/inscripciones/create.php" method="post" id="formI">
        <div class="row">
          <div class="col-md-12">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <input type="textarea" name="ocupacion" class="form-control" required>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      <label for="lugar_trabajo">Lugar de trabajo</label>
                      <input type="textarea" name="lugar_trabajo" class="form-control" required>
                    </div>
                  </div>
                    ...
                    while ($i < count($listaAnos)) {
                      ...
                      echo "<td style='display: flex;
                           ...
                           <div class='btn-group' role='group' aria-label='Basic example'>
                            <input type='radio' name='grado' value=" . $listaGrados[$i]->id_grado_seccion . " 
                           </div>
                        </td>";
                      echo "</tr>";
