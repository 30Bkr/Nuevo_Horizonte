...
// try {
//     // Obtener ID de la reinscripción
...
//     // CONSULTA PARA OBTENER DATOS DE LA REINSCRIPCIÓN
//     $sql_inscripcion = "
//         SELECT
//             I.id_inscripcion,
...
//                 ha sido REINSCRITO en esta institución para cursar el <strong>' . $datos['nivel_seccion'] . '</strong> 
...
//     $filename = 'constancia_reinscripcion_' . $datos['cedula_estudiante'] . '_' . date('Y-m-d') . '.pdf';
