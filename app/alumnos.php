...
class Alumnos
{
  ...
  public function consultar($id)
  {
    try {
      ...
      $sql = "SELECT * FROM personas as per
              INNER JOIN estudiantes as alu ON per.id_persona = alu.id_persona
      ...
      while ($row = $stmt->fetch(PDO::FETCH_OBJ)) {
        ...
        $objPersona->alergias = $row->alergias;
        $objPersona->nombre_rol = $row->nombre_rol;
        $objPersona->condiciones = $row->condiciones;
  ...
  public function actualizar($id)
  {
    try {
      ...
      $sql = "UPDATE personas 
            ...
            SET personas.id_rol = :id_rol, personas.nombres = :nombres, personas.apellidos = :apellidos,  personas.correo = :correo, personas.telefono = :telefono, personas.telefono_hab = :telefono_hab, personas.fecha_nac = :fecha_nac, personas.lugar_nac = :lugar_nac, personas.cedula = :cedula, personas.sexo = :sexo, personas.nacionalidad = :nacionalidad, personas.calle = :calle, personas.casa = :casa, personas.parroquia = :parroquia, personas.estado = :estado, estudiantes.alergias = :alergias, estudiantes.condiciones = :condiciones
