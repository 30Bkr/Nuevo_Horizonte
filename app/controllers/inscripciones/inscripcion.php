...
class Inscripcion
{
  ...
  public function inscribirSecundaria()
  {
    ...
    try {
      ...
      $sql6 = "INSERT INTO inscripcion_media (id_estudiante_representante, id_año_seccion, id_periodo)
                VALUES (:id_estudiante_representante, :id_año_seccion, :id_periodo);";
      $stmt6 = $objPersonas->prepare($sql6);
      $stmt6->bindParam(':id_estudiante_representante', $id_estudiante_repre);
      $stmt6->bindParam(':id_año_seccion', $this->id_año_seccion);
      $stmt6->bindParam(':id_periodo', $this->periodo);
      echo "$id_estudiante_repre";
      echo $this->id_año_seccion;
      echo $this->periodo;
      $stmt6->execute();
      $stmt = null;
      $stmt2 = null;
