De acuerdo deep. Ya tienes la informacion de mi base de datos. en la tabla de niveles_secciones como puedes ver notamos que guardamos la combinacion de id_nivel y id_seccion para referirnos a 1 seccion en especifico. Validamos a demás la capacidad. Necesito que en el apartado de seleccionar el grado y la seccion valide si hay cupos disponibles para poder inscribir al estudiante e indique si es posible y cuantos cupos quedan disponibles y que a nivel de backend valide si es posible dicha inscripcions, de ser posible se ejecute la inscripcion correctamente.
Codigo a nivel de front-end:
<?php
...
?>
Codigo al nivel de brackend en inscripciong2.php:
<?php
session_start();
