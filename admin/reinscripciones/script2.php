...
<script>
  ...
  document.getElementById('form-reinscripcion').addEventListener('submit', function(e) {
    ...
    if (mismaCasa === 'no') {
      ...
      // Validar que id_direccion_est esté vacío cuando NO viven juntos
      if (idDireccionEst) {
        console.warn('⚠️ Advertencia: id_direccion_est tiene valor cuando no viven juntos:', idDireccionEst);
        // Forzar a vacío para crear nueva dirección
      ...
      console.log('✅ Dirección validada - usando dirección del representante:', idDireccionEst);
    }
