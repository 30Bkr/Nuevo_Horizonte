...
try {
  ...
  if ($representante_existente === '1') {
    // Representante existe - actualizar datos
    ...
    error_log("Actualizando representante existente ID: " . $id_representante);
    ...
    error_log("Actualizando persona representante");
    ...
    // Representante no existe - crear nuevo
